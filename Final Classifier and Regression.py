...
#After building a classifier/regressor, it will start a loop, in which the user should enter a list of defected gene ids, separated by commas
#The code will run the ontotype on the list, and return the prediction of the classifier/regressor on the result

#To end the loop, enter a hashtag instead of gene ids list
 
from ontotype.initialization import *
from ontotype.ontotype_classes import *
from model.data_test import *
from sys import *


create_initialization_map("ontotype/mart_export.csv","ontotype/go_to_parent.csv")
Ontotype = build_ontotype()
